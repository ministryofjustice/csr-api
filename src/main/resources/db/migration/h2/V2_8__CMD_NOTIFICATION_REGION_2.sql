...
CREATE OR REPLACE TABLE R2.CMD_NOTIFICATION
(
...
CREATE INDEX R2.CMD_NOTIFICATION_PROCESSED_X01 ON R2.CMD_NOTIFICATION (PROCESSED, LASTMODIFIED);

CREATE SEQUENCE R2.CMD_NOTIFICATION_ID START WITH 1;
